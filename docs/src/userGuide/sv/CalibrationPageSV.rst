...
You need to have selected the observation mode and added a target to your submission to see the calibration strategy. 
...
2. **Target name and integration time of the observation**: This section shows:
   - Target Name: Automatically retrieved from the submission based on the linked observation.
