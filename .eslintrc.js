module.exports = {
  ...
  rules: {
    ...
    '@typescript-eslint/comma-dangle': 0, // TAS : disabled for now
    'class-methods-use-this': 'off',
    'comma-dangle': 0,
    'import/no-cycle': 'off',
    'import/no-extraneous-dependencies': 'off',
    'import/order': 0, // TAS : disabled for now
    ...
    'react/require-default-props': 0, // TAS : disabled for now
    'react/function-component-definition': 'off',
    'react/display-name': 'off',
    'consistent-return': 0, // TAS : disabled for now
    ...
    '@typescript-eslint/no-shadow': ['off'], // TAS : changed from Error
    'no-bitwise': 'off',
