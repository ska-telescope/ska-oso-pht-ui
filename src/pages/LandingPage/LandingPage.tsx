...
import { NAV, SEARCH_TYPE_OPTIONS, PROPOSAL_STATUS, PATH, NOTSPECIFIED } from '../../utils/constants';
...
export default function LandingPage() {
  ...
  const COLUMNS = [
    { field: 'id', headerName: t('id.label'), width: 200 },
    {
      ...
      width: 200,
      renderCell: (e: { row: any }) => t('scienceCategory.' + displayScienceCategory(e.row.scienceCategory))
    },
