...
export const HELP_EFFECTIVE_RESOLUTION = [ 'EFFECTIVE RESOLUTION TITLE', 'EFFECTIVE RESOLUTION DESCRIPTION', '' ];
...
export const HELP_SPECTRAL_AVERAGING = [ 'SPECTRAL AVERAGING TITLE', 'SPECTRAL AVERAGING DESCRIPTION', '' ];
export const HELP_SPECTRAL_RESOLUTION = [ 'SPECTRAL RESOLUTION TITLE', 'SPECTRAL RESOLUTION DESCRIPTION', '' ];
...
export const HELP_CONTINUUM_BANDWIDTH = [ 'CONTINUUM BANDWIDTH TITLE', 'CONTINUUM BANDWIDTH DESCRIPTION', '' ];
...
export default function AddObservation() {
  ...
  const pageFooter = () => {
    ...
    const addObservationToProposal = () => {
      ...
      setProposal({ ...getProposal(), observations: [...getProposal().observations, newObservation] });
    };
