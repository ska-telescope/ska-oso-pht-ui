...
describe('Content', () => {
  ...
  describe('First Name Input', () => {
    ...
    it('should clear the First Name helper text when text is cleared', () => {
      const incorrectText = 'XXX*%$';
      cy.get('[data-testid="firstName"] input').type(incorrectText);
      cy.get('[data-testid="firstName"] > p.Mui-error').should('exist').contains('specialCharacters.invalid');
      cy.get('[data-testid="firstName"] input').clear();
      cy.get('[data-testid="firstName"] > p.Mui-error').should('exist').contains('entryField.required');
    });
  ...
  describe('Last Name Input', () => {
    ...
    it('should clear the Last Name helper text when text is cleared', () => {
      const incorrectText = 'XXX*%$';
      cy.get('[data-testid="lastName"] input').type(incorrectText);
      cy.get('[data-testid="lastName"] > p.Mui-error').should('exist').contains('specialCharacters.invalid');
      cy.get('[data-testid="lastName"] input').clear();
      cy.get('[data-testid="lastName"] > p.Mui-error').should('exist').contains('entryField.required');
    });
  ...
  describe('Email Input', () => {
    ...
    it('should clear the Email helper text when text is cleared', () => {
      const incorrectText = 'XXX*%$';
      cy.get('[data-testid="email"] input').type(incorrectText);
      cy.get('[data-testid="email"] > p.Mui-error').should('exist').contains('specialCharacters.email');
      cy.get('[data-testid="email"] input').clear();
      cy.get('[data-testid="email"] > p.Mui-error').should('exist').contains('entryField.required');
    });
