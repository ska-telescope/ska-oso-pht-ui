...
export const SENSCALC_CONTINUUM_MOCKED: SensCalcResults = {
  ...
  section1: [
    ...
    { field: 'continuumSynthBeamSize', value: '190.0 x 171.3', units: 'arcsecs\xb2' },
  ...
  section2: [
    ...
    { field: 'spectralSynthBeamSize', value: '230.0 x 207.8', units: 'arcsecs\xb2' },
...
export const SENSCALC_SPECTRAL_MOCKED: SensCalcResults = {
  ...
  section1: [
    ...
    { field: 'spectralSynthBeamSize', value: '190.0 x 171.3', units: 'arcsecs\xb2' },
