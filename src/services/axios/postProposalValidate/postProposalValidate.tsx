...
/*
TODO:
- test mapping with data and map all new properties
- tidy up and remove all old mapping functions in this file
- move mapping into a separate service that can be used by putProposal and validateProposal to avoid duplication
*/

function mappingPostValidateProposal(proposal: Proposal, status: string) {
