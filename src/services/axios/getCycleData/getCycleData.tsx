...
import {
  ...
  ObservatoryDataFrontend,
} from '@/utils/types/cycleData';
...
const mappingNew = (inData: ObservatoryDataBackend): ObservatoryDataFrontend => {
  ...
  return {
    observatoryPolicy: {
      ...
      cyclePolicies: inData.observatory_policy.cycle_policies.normal_max_hours,
      telescopeCapabilities: inData.observatory_policy.telescope_capabilities.map(telescope => ({
        Low: telescope.Low,
        Mid: telescope.Mid,
      })),
    },
