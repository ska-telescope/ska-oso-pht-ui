...
import GetProposalByStatusList from './getProposalByStatusList.tsx';
...
describe('GetProposalList Service', () => {
  ...
  test('returns mapped mock data when USE_LOCAL_DATA is true', async () => {
    ...
    const result = await GetProposalByStatusList(mockedAuthClient);
  ...
  test('returns mapped data from API when USE_LOCAL_DATA is false', async () => {
    ...
    const result = (await GetProposalByStatusList(mockedAuthClient)) as Proposal[];
