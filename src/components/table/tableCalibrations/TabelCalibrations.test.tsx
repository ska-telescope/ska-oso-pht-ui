...
import TableCalibrations from './TableCalibrations';
...
vi.mock('./tableCalibrationsRow/TableCalibrationsRow', () => ({
...
describe('TableCalibrations', () => {
  it('renders rows for given data', () => {
    ...
    render(<TableCalibrations data={mockData} updateFunction={vi.fn()} deleteFunction={vi.fn()} />);
  ...
  it('renders inside TableContainer', () => {
    ...
    render(<TableCalibrations data={mockData} updateFunction={vi.fn()} />);

    expect(screen.getByTestId('table-container')).toBeInTheDocument();
  });

  it('handles empty data gracefully', () => {
    render(<TableCalibrations data={[]} updateFunction={vi.fn()} />);
