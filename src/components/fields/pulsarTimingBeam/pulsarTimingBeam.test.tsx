...
describe('PulsarTimingBeamField', () => {
  it('renders without crashing', () => {
    render(<StoreProvider><PulsarTimingBeamField /></StoreProvider>);
  ...
  it('resets beam data when resetBeamData is true', () => {
    const { rerender } = render(<StoreProvider><PulsarTimingBeamField resetBeamData={false} /></StoreProvider>);
    rerender(<StoreProvider><PulsarTimingBeamField resetBeamData={true} /></StoreProvider>);
  ...
  it('calls onDialogResponse with updated beams', () => {
    ...
    render(<StoreProvider><PulsarTimingBeamField onDialogResponse={mockOnDialogResponse} /></StoreProvider>);
