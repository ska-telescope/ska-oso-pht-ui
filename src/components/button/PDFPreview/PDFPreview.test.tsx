  ...
  cy.mount(
    <ThemeProvider theme={theme(theTheme)}>
      ...
      <Router location="/" navigator={undefined}>
        <PDFPreviewButton action={'action URL'} />
      </Router>
    </ThemeProvider>
  );
}
...
function validate(inLabel, inToolTip) {
  cy.get('[data-testid="pdfPreviewButtonTestId"]').contains(inLabel);
...
function buttonDisabled() {
  // cy.get('[data-testid="pdfPreviewButtonTestId"]').should('be.disabled');
}
