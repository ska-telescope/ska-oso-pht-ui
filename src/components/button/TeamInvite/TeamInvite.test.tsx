  ...
  cy.mount(
    <ThemeProvider theme={theme(theTheme)}>
      ...
      <Router location="/" navigator={undefined}>
        <TeamInviteButton action={'action URL'} />
      </Router>
    </ThemeProvider>
  );
}
...
function validate(inLabel, inToolTip) {
  cy.get('[data-testid="teamInviteButtonTestId"]').contains(inLabel);
...
function buttonDisabled() {
  // cy.get('[data-testid="teamInviteButtonTestId"]').should('be.disabled');
}
