  ...
  cy.mount(
    <ThemeProvider theme={theme(theTheme)}>
      ...
      <Router location="/" navigator={undefined}>
        <PreviousPageButton action={'action URL'} />
      </Router>
    </ThemeProvider>
  );
}
...
function validate(inLabel, inToolTip) {
  cy.get('[data-testid="previousPageButtonTestId"]').contains(inLabel);
...
function buttonDisabled() {
  // cy.get('[data-testid="previousPageButtonTestId"]').should('be.disabled');
}
