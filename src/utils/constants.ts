...
export const S3_SIGNED_URL_OVERRIDE = env.REACT_APP_S3_SIGNED_URL_OVERRIDE ?? '';
export const S3_SIGNED_URL_BUCKET_REWRITE_FROM =
  env.REACT_APP_S3_SIGNED_URL_BUCKET_REWRITE_FROM ?? '';
export const S3_SIGNED_URL_BUCKET_REWRITE_TO = env.REACT_APP_S3_SIGNED_URL_BUCKET_REWRITE_TO ?? '';
