...
export const OPS_REVIEWER_CHAIR = 'obs-oauth2role-opsproposaladmin-1-1535351309'; //'ce3627de-8ec2-4a35-ab1e-300eec6a0a50';
...
export const isReviewerChair = () => hasAccess(SW_ENGINEER) || hasAccess(OPS_REVIEWER_CHAIR);
