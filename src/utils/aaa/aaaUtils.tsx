...
export const OPS_PROPOSAL_ADMIN = 'obs-oauth2role-opsproposaladmin-1-1535351309'; //'ce3627de-8ec2-4a35-ab1e-300eec6a0a50';
export const OPS_REVIEWER_CHAIR = 'obs-oauth2role-opsreviewerchair-11741547065'; //'ce3627de-8ec2-4a35-ab1e-300eec6a0a50';
export const OPS_REVIEWER_SCIENCE = 'obs-oauth2role-opsreviewersci-1635769025'; // '05883c37-b723-4b63-9216-0a789a61cb07';
export const OPS_REVIEWER_TECHNICAL = 'obs-oauth2role-opsreviewertec-1-1994146425'; // '4c45b2ea-1b56-4b2d-b209-8d970b4e39dc';
...
export const isReviewerScience = () => isSoftwareEngineer() || hasAccess(OPS_REVIEWER_SCIENCE);
export const isReviewerTechnical = () => isSoftwareEngineer() || hasAccess(OPS_REVIEWER_TECHNICAL);
export const isReviewer = () => isReviewerScience() || isReviewerTechnical();
export const isReviewerChair = () => isSoftwareEngineer() || hasAccess(OPS_REVIEWER_CHAIR);
