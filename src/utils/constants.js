...
export const USE_DUMMY_EDIT = env.REACT_APP_USE_LOCAL_DATA;
...
/*
the following SCIENCE_CATEGORY, SCIENCE_SUB_CATEGORY, PROPOSAL_MAIN_TYPE, PROPOSAL_SUB_TYPE and CYCLE 
need to stay in the frontend until telescope data is ready
TODO: use this in proposals???
*/

export const SCIENCE_CATEGORY = {
  COS: "Cosmology",
  COL: "Cradle of Life",
  EOR: "Epoch of Reionization",
  EGC: "Extra Galactic continuum",
  EGSL: "Extra Galactic Spectral line",
  GW: "Gravitational Waves",
  HECP: "High Energy Cosmic Particles",
  HGS: "HI Galaxy science", 
  MAG: "Magnetism",
  OG: "Our Galaxy", 
  PUL: "Pulsars",
  SOL: "Solar",
  HAIP: "Heliospheric and Ionospheric Physics", 
  TRA: "Transients", 
  VLBI: "VLBI" 
};

export const SCIENCE_SUB_CATEGORY = {}

export const PROPOSAL_MAIN_TYPE = {
  DDT: "DDT",
  SPIP: "Standard (PI) Proposal",
  KSP: "Key Science Project"
};

export const PROPOSAL_SUB_TYPE = {
  TOO: "Target of opportunity",
  JSP: "Joint SKA proposal",
  CP: "Coordinated Proposal",
  LTP: "Long term proposal"
};

export const CYCLE = {
  cycle: "ska_32034_01",
  proposal_main_type: PROPOSAL_MAIN_TYPE.KSP,
  proposal_sub_type: PROPOSAL_SUB_TYPE.TOO
}
