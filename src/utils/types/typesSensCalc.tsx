...
export const NEW_STANDARD_DATA_LOW = {
  ...
  num13mAntennas: 64,
  numStations: 512,
  skyDirectionType: REFERENCE_COORDINATE_TYPE_GALACTIC.value,
  raGalactic: { value: DEFAULT_GALACTIC, unit: REFERENCE_COORDINATE_TYPE_GALACTIC.value },
  decGalactic: { value: DEFAULT_GALACTIC, unit: REFERENCE_COORDINATE_TYPE_GALACTIC.value },
  raEquatorial: { value: DEFAULT_EQUATORIAL, unit: REFERENCE_COORDINATE_TYPE_ICRS.value },
  decEquatorial: { value: DEFAULT_EQUATORIAL, unit: REFERENCE_COORDINATE_TYPE_ICRS.value },
